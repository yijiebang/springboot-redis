...
public class MysqlGenerator {
    ...
    public static void Generator(String[] tableName) {
        ...
        gc.setOutputDir( "d:/springboot-mybatisplus/src/main/java")
                .setActiveRecord(true)// 是否支持 AR
                .setAuthor("yjb") //设置作者名字
        ...
        dsc.setDbType(DbType.MARIADB)
                .setUrl("jdbc:mysql://localhost:3306/springboot?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC")
        ...
        pc.setParent("com.yjb")//配置父包路径
                .setModuleName("web")//配置业务包路径
                .setMapper("mapper")
                .setEntity("entity")
                .setService("service")
    ...
    public static void main(String[] args) {
        Generator(new String[]{"login", "user"});
    }
}
